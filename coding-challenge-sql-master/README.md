...
* FILL-ME 1
1. The domain design could have been better. Currently it revolving around the Table. Somehow the description make my mind to do so.
2. Test cases can be imporve further with intigration tests. 
3. Cleaning code round 2 is remaining.
4. 
